...
{ 
    ...
    public function updateCategory($itm) 
    {
        ...
        $stmt = $this->pdo->prepare('UPDATE tbl_eventfinder_categories 
    ...
    {
        $stmt = $this->pdo->prepare('INSERT INTO tbl_eventfinder_categories( 
                                            category,
                                            category_icon,
                                            created_at,
                                            updated_at ) 
    ...
    {
        $stmt = $this->pdo->prepare('SELECT * 
                                        FROM tbl_eventfinder_categories WHERE category_id = :category_id');
    ...
    {
        $stmt = $this->pdo->prepare('SELECT * 
                                        FROM tbl_eventfinder_categories WHERE category = :category');
    ...
    {
        $stmt = $this->pdo->prepare('SELECT tbl_eventfinder_categories.category_id,
                                            tbl_eventfinder_categories.category,
                                            tbl_eventfinder_categories.category_icon,
                                            tbl_eventfinder_categories.created_at,
                                            tbl_eventfinder_categories.updated_at,
                                            tbl_eventfinder_categories.is_deleted  
                                FROM tbl_eventfinder_categories 
                                INNER JOIN tbl_eventfinder_event_categories ON
                                tbl_eventfinder_categories.category_id = tbl_eventfinder_event_categories.category_id 
                                 WHERE tbl_eventfinder_categories.is_deleted = 0 AND tbl_eventfinder_event_categories.is_deleted = 0 AND tbl_eventfinder_event_categories.event_id = :event_id ORDER BY category ASC');
