...
class ControllerAuthentication
{
    ...
    public function login($username, $password) 
    {
        $stmt = $this->pdo->prepare('SELECT * 
                                FROM tbl_eventfinder_authentication 
    ...
    {
        $stmt = $this->pdo->prepare('INSERT INTO tbl_eventfinder_authentication( username, password, name, role_id ) 
    ...
    public function updateAccessUser($itm) 
    {
        ...
        $stmt = $this->pdo->prepare('UPDATE tbl_eventfinder_authentication 
                                        SET 
                                            username = :username,
                                            password = :password,
                                            name = :name
    ...
    public function denyAccessUser($authentication_id, $deny_access) 
    {
