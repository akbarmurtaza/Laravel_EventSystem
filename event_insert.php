    		...
    		<div class="col-md-12">
		    	<div class="panel panel-default">
		            ...
		            <div class="panel-heading clearfix">
		            	<h4 class="panel-title pull-left" style="padding-top:7px;padding-bottom:6px;">Add Event</h4>
				        ...
				        <div class="panel-body">
				            <div class="row">
				                <div class="col-md-7">
				                    ...
				                    <div class="input-group">
				                        <span class="input-group-addon"></span>
				                        <input type="text" class="form-control" placeholder="Address" name="address" required id="txtAddress">
				                    ...
				                    <div class="input-group">
				                        <span class="input-group-addon"></span>
				                        <input type="text" class="form-control" placeholder="Ticket URL" name="ticket_url">
				                    </div>
                                    ...
                                    <div class="input-group" style="width:100%;" >
                                        <select class="form-control" style="width:100%;" name="is_featured">
                                            ...
                                            <option value="1">Event will be Featured</option>
                                            <option value="0">Event will not be Featured</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="dtp_input1" value="" name="gmt_date_set"/>
                                    </div>

				                    <div>
				                        <input type="hidden" placeholder="Latitude" name="lat" id="latitude" required>
				                        <input type="hidden" placeholder="Longitude" name="lon" id="longitude" required>
				                    </div>
				                    ...
				                    <div class="input-group">
				                        <span class="input-group-addon"></span>
				                        <textarea type="text" class="form-control" placeholder="Description" rows="10" name="event_desc" id="details"></textarea>
				                    </div>
                                                ...
                                                <?php
                                                    ...
                                                    if($categories != null) {
                                                        foreach ($categories as $category)  {
                                                            ...
                                                            echo "<td><input type='checkbox' name='chk_categories[]' value='$category->category_id'> $category->category</td>";
                                                            if($ind == 2) {
                                                                $ind = 1;
                                                                echo "</tr>";
                                                            }
